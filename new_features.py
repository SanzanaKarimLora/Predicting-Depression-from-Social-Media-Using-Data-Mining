...
#freq = pd.Series(' '.join(data['message']).split()).value_counts()[-10000:]
...
X_train, X_val, y_train, y_val = train_test_split(data.message.values, y, stratify=y, random_state=42, test_size=0.1, shuffle=True)
...
tweets = pd.DataFrame(['Depression',
'Feeling helpless',
'not bad',
